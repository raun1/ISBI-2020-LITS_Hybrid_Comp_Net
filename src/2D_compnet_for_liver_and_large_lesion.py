...
#Please note the model needs to be compiled twice using the setup mentioned in the paper https://arxiv.org/pdf/1909.04797.pdf and model.fit needs to be run twice too 
